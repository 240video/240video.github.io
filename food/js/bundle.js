...
function calc() {
    ...
    function initLocalSetting(selctor, classActive) {
        const element = document.querySelectorAll(selctor);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2023-11-20', '.promotion');
}); 
})();
